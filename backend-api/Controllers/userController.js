...
const registerUser = async (req,res) => {
    try {
        ...
        if(!validator.isStrongPassword(password)) return res.status(400).json("Password is not strong password");
...
module.exports = {registerUser, loginUser, singleUser, allUser}